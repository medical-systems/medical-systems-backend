...
- change `appointments` folder to the app name of your choice
- Search through entire code base for `Appointment`,`Appointments` and `appointments` to modify code to use your resource
  - `project/settings.py`
  - `project/urls.py`
  - App's files
    - `views.py`
...
- Update AppointmentModel with fields you need
